...
export function handleTransfer(event: ethereum.Transfer): void {
  // Bu fonksiyon, subgraph.yaml dosyasında belirtilen Transfer olayını işler.
  // Şu an için boş bırakıyoruz, çünkü blok ve işlem verilerini zaten işliyoruz.
}
